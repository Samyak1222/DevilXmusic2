...
OWNER_USERNAME = getenv("OWNER_USERNAME","Devill82")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME" , "Devil_x2_musicbot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "ᎫᎪᎪΝ Х ᎷႮՏᏆᏟ")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME" , None)
EVALOP = list(map(int, getenv("EVALOP", "6843070935").split()))
...
LOGGER_ID = int(getenv("LOGGER_ID", -1001924990291))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Samyak1222/DevilXmusic2",
)
